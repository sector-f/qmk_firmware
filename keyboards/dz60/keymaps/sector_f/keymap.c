...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        // Function keys; RBG keys
        // Came with this layout
        // Will probably modify later
        LAYOUT_60_ansi(
        ...
        // hjkl arrow keys; everything else KC_TRNS
        LAYOUT_60_ansi(
        ...
        LAYOUT_60_ansi(
                ...
                KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_KP_4, KC_KP_5, KC_KP_6,  KC_TRNS, KC_TRNS, KC_TRNS,
